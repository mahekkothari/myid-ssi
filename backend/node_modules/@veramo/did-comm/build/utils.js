...
export async function extractSenderEncryptionKey(jwe, context, resolutionOptions) {
    let senderKey = null;
...
export async function mapRecipientsToLocalKeys(managedKeys, context, resolutionOptions) {
