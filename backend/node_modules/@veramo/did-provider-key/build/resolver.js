import { bytesToBase58, bytesToMultibase, convertEd25519PublicKeyToX25519, createJWK, multibaseToBytes, } from '@veramo/utils';
var SupportedVerificationMethods;
(function (SupportedVerificationMethods) {
    SupportedVerificationMethods[SupportedVerificationMethods["JsonWebKey2020"] = 0] = "JsonWebKey2020";
    SupportedVerificationMethods[SupportedVerificationMethods["Multikey"] = 1] = "Multikey";
    SupportedVerificationMethods[SupportedVerificationMethods["EcdsaSecp256k1VerificationKey2019"] = 2] = "EcdsaSecp256k1VerificationKey2019";
    SupportedVerificationMethods[SupportedVerificationMethods["EcdsaSecp256k1VerificationKey2020"] = 3] = "EcdsaSecp256k1VerificationKey2020";
    SupportedVerificationMethods[SupportedVerificationMethods["Ed25519VerificationKey2020"] = 4] = "Ed25519VerificationKey2020";
    SupportedVerificationMethods[SupportedVerificationMethods["Ed25519VerificationKey2018"] = 5] = "Ed25519VerificationKey2018";
    SupportedVerificationMethods[SupportedVerificationMethods["X25519KeyAgreementKey2020"] = 6] = "X25519KeyAgreementKey2020";
    SupportedVerificationMethods[SupportedVerificationMethods["X25519KeyAgreementKey2019"] = 7] = "X25519KeyAgreementKey2019";
    SupportedVerificationMethods[SupportedVerificationMethods["EcdsaSecp256r1VerificationKey2019"] = 8] = "EcdsaSecp256r1VerificationKey2019";
})(SupportedVerificationMethods || (SupportedVerificationMethods = {}));
const contextFromKeyFormat = {
...
function resolveECDSA(did, options) {
    ...
    switch (publicKeyFormat) {
        ...
        case 'EcdsaSecp256r1VerificationKey2019':
            verificationMethod.publicKeyJwk = createJWK(jwkKeyType, keyBytes, 'sig');
            break;
        case 'Multikey':
    ...
    if (options.accept === 'application/did+json') {
        ...
        throw new Error(`unsupportedFormat: The DID resolver does not support the requested 'accept' format: ${options.accept}`);
    }
    return {
...
function resolveEDDSA(did, options) {
    const publicKeyFormat = options?.publicKeyFormat ?? 'JsonWebKey2020';
    const keyMultibase = did.substring(8);
    const { keyBytes, keyType } = multibaseToBytes(keyMultibase);
    ...
    let keyAgreementKeyFormat = publicKeyFormat;
    switch (publicKeyFormat) {
        case 'JsonWebKey2020':
            verificationMethod.publicKeyJwk = createJWK(keyType, keyBytes, 'sig');
            break;
        case 'Multikey':
            verificationMethod.publicKeyMultibase = keyMultibase;
            break;
...
function resolveX25519(did, options) {
    const publicKeyFormat = options?.publicKeyFormat ?? 'JsonWebKey2020';
    const keyMultibase = did.substring(8);
    const { keyBytes, keyType } = multibaseToBytes(keyMultibase);
    ...
    switch (publicKeyFormat) {
        case 'JsonWebKey2020':
            verificationMethod.publicKeyJwk = createJWK(keyType, keyBytes, 'enc');
            break;
        case 'Multikey':
